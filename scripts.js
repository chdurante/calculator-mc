...
const receitas = {
    // Pistolas
    beretta: { cobalto: 35, aco: 30, aluminioNaval: 25, polietileno: 35, cripto: 0 },
    ruger: { cobalto: 50, aco: 45, aluminioNaval: 35, polietileno: 45, cripto: 0 },
    revolver: { cobalto: 65, aco: 55, aluminioNaval: 45, polietileno: 60, cripto: 0 },
    pistola50: { cobalto: 90, aco: 70, aluminioNaval: 55, polietileno: 85, cripto: 0 },

    // Submetralhadoras
    uzi: { cobalto: 120, aco: 100, aluminioNaval: 85, polietileno: 115, cripto: 0 },
    evo: { cobalto: 120, aco: 100, aluminioNaval: 85, polietileno: 115, cripto: 0 },
    krv: { cobalto: 120, aco: 100, aluminioNaval: 85, polietileno: 115, cripto: 0 },
    akcompacta: { cobalto: 120, aco: 100, aluminioNaval: 85, polietileno: 115, cripto: 0 },
    doze: { cobalto: 280, aco: 240, aluminioNaval: 240, polietileno: 260, cripto: 0 },

    // Fuzis
    ak47: { cobalto: 160, aco: 150, aluminioNaval: 130, polietileno: 160, cripto: 0 },
    scar: { cobalto: 160, aco: 150, aluminioNaval: 130, polietileno: 160, cripto: 0 },

   // Attachments
    silenciador: { polietileno: 100, borrachaFluorada: 100, cobalto: 100, aluminioNaval: 100 },
    silenciadorHeavy: { polietileno: 200, borrachaFluorada: 200, cobalto: 200, aluminioNaval: 200 },
    ...
    lanternaTatica: { polietileno: 5, borrachaFluorada: 5, cobalto: 5, vidroTemperado: 5, titanio: 5 },
...
const receitasComCripto = {
    // Pistolas
    beretta: { cobalto: 25, aco: 20, aluminioNaval: 15, polietileno: 25, cripto: 4 },
    ruger: { cobalto: 40, aco: 35, aluminioNaval: 25, polietileno: 35, cripto: 4 },
    revolver: { cobalto: 55, aco: 45, aluminioNaval: 35, polietileno: 50, cripto: 4 },
    pistola50: { cobalto: 80, aco: 60, aluminioNaval: 45, polietileno: 75, cripto: 4 },

    // Submetralhadoras
    uzi: { cobalto: 110, aco: 90, aluminioNaval: 75, polietileno: 105, cripto: 8 },
    evo: { cobalto: 110, aco: 90, aluminioNaval: 75, polietileno: 105, cripto: 8 },
    krv: { cobalto: 110, aco: 90, aluminioNaval: 75, polietileno: 105, cripto: 8 },
    akcompacta: { cobalto: 110, aco: 90, aluminioNaval: 75, polietileno: 105, cripto: 8 },
    doze: { cobalto: 270, aco: 230, aluminioNaval: 230, polietileno: 250, cripto: 8 },

    // Fuzis
    ak47: { cobalto: 150, aco: 140, aluminioNaval: 120, polietileno: 150, cripto: 8 },
    scar: { cobalto: 150, aco: 140, aluminioNaval: 120, polietileno: 150, cripto: 8 },
...
const itens = {
    // Pistolas
    beretta: { nome: "Beretta", categoria: "pistolas", ico: "images/beretta.png" },
    ruger: { nome: "Ruger", categoria: "pistolas", ico: "images/ruger.png" },
    revolver: { nome: "Revólver", categoria: "pistolas", ico: "images/revolver.png" },
    pistola50: { nome: "Pistola .50", categoria: "pistolas", ico: "images/pistola50.png" },

    // Submetralhadoras
    uzi: { nome: "Uzi", categoria: "subs", ico: "images/uzi.png" },
    evo: { nome: "EVO", categoria: "subs", ico: "images/evo.png" },
    akcompacta: { nome: "AK Compacta", categoria: "subs", ico: "images/akcompacta.png" },
    ...
    // Attachments
    silenciador: { nome: "Silenciador", categoria: "attachments", ico: "images/silenciador.png" },
    silenciadorHeavy: { nome: "Silenciador Heavy", categoria: "attachments", ico: "images/silenciadorHeavy.png" },
    penteEstendidoPistola: { nome: "Pente Estendido Pistola", categoria: "attachments", ico: "images/penteEstendidoPistola.png" },
    penteEstendidoSMG: { nome: "Pente Estendido SMG", categoria: "attachments", ico: "images/penteEstendidoSMG.png" },
    lanternaTatica: { nome: "Lanterna Tática", categoria: "attachments", ico: "images/lanternaTatica.png" },
...
function gerarHTMLCategorias() {
    ...
    for (const [categoriaKey, categoria] of Object.entries(categorias)) {
        const itensCategoria = Object.entries(itens).filter(([_, item]) => item.categoria === categoriaKey);
        ...
        if (itensCategoria.length > 0) {
            ...
            categoriaHeader.style.cssText = "display: flex; align-items: center; justify-content: center; gap: 8px; text-align: center;";
            ...
            itensCategoria.forEach(([itemKey, item]) => {
                ...
                itemImage.style.cssText = "width: 48px; height: 48px; margin-bottom: 8px;";
                ...
                informativo.style.cssText = "text-align: center; font-size: 12px; margin-top: 8px;";
                const materiais = receitas[itemKey]
                    ? Object.entries(receitas[itemKey])
                        .map(([mat, qtd]) => `${qtd} ${mat.charAt(0).toUpperCase() + mat.slice(1)}`)
                        .join(", ")
                    : "Receita não encontrada";
                const valorUnitario = precos[itemKey] ? ` (Valor Unitário: R$ ${precos[itemKey].toFixed(2)})` : "";
    ...
    resultDiv.innerHTML += `
        <div style="display: flex; justify-content: space-around; align-items: center; flex-wrap: wrap; margin-top: 20px; gap: 20px;">
            <div style="text-align: center; background-color: #111; padding: 12px 20px; border-radius: 10px; border: 2px solid #FFD700;">
                ...
                <p style="font-size: 18px; font-weight: bold; color: #FFD700;">${Math.ceil(reciclado).toLocaleString('pt-BR')}</p>
            </div>
            <div style="text-align: center; background-color: #111; padding: 12px 20px; border-radius: 10px; border: 2px solid #00ff99;">
                ...
                <p style="font-size: 18px; font-weight: bold; color: #00ff99;">R$ ${valorTotal.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
            </div>
        </div>
    `;
}
